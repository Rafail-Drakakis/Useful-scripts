...
# Install software
sudo apt install software-properties-common apt-transport-https filezilla copyq wget clang-format-11 python3 python3-pip qbittorrent g++ cmake vlc git tree htop nmap ssh screen unzip curl gparted vim -y
sudo snap install notepad-plus-plus code -y
pip install numpy pandas matplotlib requests beautifulsoup4 pygame pytube openpyxl yt-dlp jupyter
